...
# For drawing facial landmarks (optional)
mp_drawing = mp.solutions.drawing_utils
drawing_spec = mp_drawing.DrawingSpec(thickness=1, circle_radius=1)

# Define eye landmark indices for MediaPipe Face Mesh
# These indices have been commonly used in several tutorials.
...
while True:
    ...
    # Flip frame horizontally for a selfie-view display and convert color to RGB
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            # Optionally, draw eye landmarks on the frame
            ...
            # Optionally draw the full face mesh on the frame
        ...
        # If no face is detected, reset counter and ensure alarm is off.
        COUNTER = 0
        if ALARM_ON:
            ALARM_ON = False
            pygame.mixer.music.stop()
